...
// TODO: move to utils/helper lib
time_t Status::calculateUnixTime(uint8_t y, uint8_t mo, uint8_t d, uint8_t h, uint8_t m, uint8_t s, bool dst)
{
    struct tm time;
